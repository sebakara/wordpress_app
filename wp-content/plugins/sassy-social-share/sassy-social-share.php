...
define( 'HEATEOR_SSS_VERSION', '3.3.54' );
...
function heateor_sss_save_default_options() {
	...
	add_option( 'heateor_sss', array(
	   ...
	   'instagram_username' => '',
	   'horizontal_re_providers' => array( 'facebook', 'X', 'reddit', 'linkedin', 'pinterest', 'MeWe', 'mix', 'whatsapp' ),
	   ...
	   'vertical_re_providers' => array( 'facebook', 'X', 'reddit', 'linkedin', 'pinterest', 'MeWe', 'mix', 'whatsapp' ),
	   'vertical_bg' => '',
	   'alignment' => 'left',
	   'left_offset' => '-10',
	   'right_offset' => '-10',
