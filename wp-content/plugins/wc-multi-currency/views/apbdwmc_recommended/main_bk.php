...
<div class="apbd-recommended-container mt-3">
    <div class="card-deck mb-3">
        ...
        <div class="card animated ape-fadeIn">
            ...
            <div class="card-footer app-rec-buttons text-right">
                <?php echo esc_attr($this->getButtonInstallLinkHtml("elite-licenser-lite","elite-licenser-lite/elitelicenserlite.php",['elite-licenser/elitelicenser.php'])); ?>
        ...
        <div class="card animated ape-fadeIn">
            ...
            <div class="card-footer app-rec-buttons text-right">
	            <?php echo esc_attr($this->getButtonInstallLinkHtml("woolentor-addons","woolentor-addons/woolentor_addons_elementor.php")); ?>
