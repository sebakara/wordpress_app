					...
					<ul>
						<?php
							...
							foreach ( $currencies as $currency ) {
								...
								?>
								<li>
									<a class="<?php echo esc_attr(!empty($_default_mc_cur->code)&& $currency->code==$_default_mc_cur->code?" active ":"");?>" href="<?php echo esc_url($urlprefix); ?>_amc-currency=<?php echo esc_attr($currency->code);?>">
					...
					<ul>
						<?php
							...
							foreach ( $currencies as $currency ) {
								...
								?>
								<li>
									<a class="<?php echo esc_attr(!empty($_default_mc_cur->code)&& $currency->code==$_default_mc_cur->code?" active ":"");?>" href="<?php echo esc_attr($urlprefix); ?>_amc-currency=<?php echo esc_attr($currency->code);?>">
