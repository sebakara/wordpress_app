...
';
	...
	if ( ! function_exists("APBD_GetHTMLSwitchButton")){
		function APBD_GetHTMLSwitchButton($id,$name,$default_value="",$boolvalue,$checkedValue,$isDisabled=false,$input_class='',$label_class='bg-mat',$group_class='material-switch-sm'){
            ...
            <input  class="<?php echo esc_attr($input_class); ?>" id="<?php echo esc_attr($id); ?>" <?php echo esc_attr($isDisabled?' disabled="disabled"' :'name="'.$name.'"');?>  type="checkbox" <?php echo esc_attr($checkedValue ==$boolvalue? "checked" : "");?>  value="<?php echo esc_attr($boolvalue);?>" >
