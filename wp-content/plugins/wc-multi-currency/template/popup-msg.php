...
<div style=" position:relative;">
	...
	<div id="LightBoxBody" class="lightbox-body" style="padding:0 4px 2px;">
		<?php if(!empty($_title)){?>
			...
			if(!empty($bkbtn)){
			?>
			<a href="<?php echo esc_url($bkbtn);?>" data-effect="mfp-move-from-top" class="popupformWR btn btn-xs btn-default pull-right m-r-30"> <i class="fa fa-angle-double-left"></i> <?php _e("Back") ; ?></a>
			<?php }?>
			</h3>
        ...
        <div class="">
            ...
            <?php if(!empty($__message)){
                ?>
                <h5 class="pt-3 pb-3 text-center"><?php echo wp_kses_html($__message); ?></h5>
                <?php
            } ?>
